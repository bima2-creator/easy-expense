...
var RenderVerticalLines = function (props) {
    ...
    verticalLinesAr = props.verticalLinesAr, verticalLinesSpacing = props.verticalLinesSpacing, spacing = props.spacing, initialSpacing = props.initialSpacing, verticalLinesZIndex = props.verticalLinesZIndex, verticalLinesHeight = props.verticalLinesHeight, verticalLinesThickness = props.verticalLinesThickness, verticalLinesColor = props.verticalLinesColor, verticalLinesStrokeDashArray = props.verticalLinesStrokeDashArray, verticalLinesShift = props.verticalLinesShift, verticalLinesMarginBottom = props.verticalLinesMarginBottom, verticalLinesUptoDataPoint = props.verticalLinesUptoDataPoint, verticalLinesStrokeLinecap = props.verticalLinesStrokeLinecap, xAxisThickness = props.xAxisThickness, labelsExtraHeight = props.labelsExtraHeight, containerHeight = props.containerHeight, data = props.data, stackData = props.stackData, barWidth = props.barWidth, maxValue = props.maxValue, chartType = props.chartType, containerHeightIncludingBelowXAxis = props.containerHeightIncludingBelowXAxis, totalWidth = props.totalWidth, xAxisLabelsVerticalShift = props.xAxisLabelsVerticalShift;
    ...
    return (_jsx(View, { style: {
            ...
            zIndex: verticalLinesZIndex || -1,
                ...
                var verticalLinesShiftLocal = chartType === chartTypes.BAR
                    ...
                    : verticalLinesShift;
                var verticalLinesMarginBottomLocal = chartType === chartTypes.BAR
                    ? ((_c = (_b = item.verticalLineMarginBottom) !== null && _b !== void 0 ? _b : verticalLinesMarginBottom) !== null && _c !== void 0 ? _c : 0)
                    : (verticalLinesMarginBottom !== null && verticalLinesMarginBottom !== void 0 ? verticalLinesMarginBottom : 0);
                ...
                var lineProps = chartType === chartTypes.BAR // This logic exists because we have renderSpecificVerticalLines in Line Charts which I would love to deprecate at the earliest, because that functionality gets handled here elegantly
                    ? {
                        ...
                        stroke: ((_d = item.verticalLineColor) !== null && _d !== void 0 ? _d : verticalLinesColor) ||
                            'lightgray',
                        strokeWidth: ((_e = item.verticalLineThickness) !== null && _e !== void 0 ? _e : verticalLinesThickness) || 2,
                        strokeDasharray: (_g = (_f = item.verticalLineStrokeDashArray) !== null && _f !== void 0 ? _f : verticalLinesStrokeDashArray) !== null && _g !== void 0 ? _g : '',
                        strokeLinecap: (_h = item.verticalLineStrokeLinecap) !== null && _h !== void 0 ? _h : verticalLinesStrokeLinecap,
                    }
                    : {
                        y2: containerHeightIncludingBelowXAxis -
                            heightAdjustmentDueToStrokeLinecap -
                ...
                return (_createElement(Line, __assign({}, lineProps, { key: index, x1: x, y1: extendedContainerHeight -
                        ...
                        heightAdjustmentDueToStrokeLinecap -
                        verticalLinesMarginBottomLocal, x2: x })));
            }) }) }));
};
